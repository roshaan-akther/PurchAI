...
The `prerequisites_output` contains what a participant receives from onboarding. At minimum, this includes an **identity** (see [Payment Identity](/2026-04-08/schemas/shopping/types/payment_identity.json)). It **MAY** also include additional configuration, credentials, or settings specific to the handler.
...
The handler declaration conforms to the [`PaymentHandler`](/2026-04-08/schemas/payment_handler.json) schema. The specification **SHOULD** define the available config and instrument schemas, and how to construct each based on the business's prerequisites output and desired configuration.
...
| Schema                                                                                            | Description                                                      |
| ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| [`payment_instrument.json`](/2026-04-08/schemas/shopping/types/payment_instrument.json)           | Base: id, handler_id, type, billing_address, credential, display |
| [`card_payment_instrument.json`](/2026-04-08/schemas/shopping/types/card_payment_instrument.json) | Extends base with display: brand, last_digits, expiry, card art  |
...
Each instrument schema defines its own `available_*` variant in `$defs` that specifies what constraints are valid for that instrument type. For example, [`card_payment_instrument.json`](/2026-04-08/schemas/shopping/types/card_payment_instrument.json) defines `available_card_payment_instrument` with a `brands` constraint.

| Schema                                                                                                      | Constraints                                              |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [`available_payment_instrument.json`](/2026-04-08/schemas/shopping/types/available_payment_instrument.json) | Base: type, constraints (open object)                    |
...
| Schema                                                                                  | Description                   |
| --------------------------------------------------------------------------------------- | ----------------------------- |
| [`payment_credential.json`](/2026-04-08/schemas/shopping/types/payment_credential.json) | Base: type discriminator only |
| [`token_credential.json`](/2026-04-08/schemas/shopping/types/token_credential.json)     | Token: type + token string    |
...
```json
{
  ...
  "allOf": [
    { "$ref": "https://ucp.dev/2026-04-08/schemas/shopping/types/token_credential.json" }
  ],
  "type": "object",
...
**→ [Payment Handler Template](http://ucp.dev/2026-04-08/specification/payment-handler-template/index.md)**
...
| **Link to examples**            | Reference existing handler specs and the [Tokenization Guide](http://ucp.dev/2026-04-08/specification/tokenization-guide/index.md) for common flows. |

______________________________________________________________________

## See Also

- **[Tokenization Guide](http://ucp.dev/2026-04-08/specification/tokenization-guide/index.md)** — Guide for building tokenization payment handlers
