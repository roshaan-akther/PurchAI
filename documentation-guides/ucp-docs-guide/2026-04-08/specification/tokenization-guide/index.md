...
**OpenAPI:** [Tokenization API](/2026-04-08/handlers/tokenization/openapi.json)
...
| Example                                                                                                                | Use Case                                            |
| ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| [Processor Tokenizer](http://ucp.dev/2026-04-08/specification/examples/processor-tokenizer-payment-handler/index.md)   | Business or PSP runs tokenization and processing    |
| [Platform Tokenizer](http://ucp.dev/2026-04-08/specification/examples/platform-tokenizer-payment-handler/index.md)     | Platform tokenizes credentials for businesses/PSPs  |
| [Encrypted Credential Handler](http://ucp.dev/2026-04-08/specification/examples/encrypted-credential-handler/index.md) | Platform encrypts credentials instead of tokenizing |
...
The tokenizer **MUST** verify binding matches on `/detokenize`. See [Binding Schema](/2026-04-08/schemas/shopping/types/binding.json).
...
See the full [OpenAPI specification](/2026-04-08/handlers/tokenization/openapi.json) for complete request/response schemas.
...
| Resource                | URL                                                                                                                    |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Tokenization OpenAPI    | [handlers/tokenization/openapi.json](/2026-04-08/handlers/tokenization/openapi.json)                                   |
| Identity Schema         | [schemas/shopping/types/payment_identity.json](/2026-04-08/schemas/shopping/types/payment_identity.json)               |
| Binding Schema          | [schemas/shopping/types/binding.json](/2026-04-08/schemas/shopping/types/binding.json)                                 |
| Token Credential Schema | [schemas/shopping/types/token_credential.json](/2026-04-08/schemas/shopping/types/token_credential.json)               |
| Card Instrument Schema  | [schemas/shopping/types/card_payment_instrument.json](/2026-04-08/schemas/shopping/types/card_payment_instrument.json) |

______________________________________________________________________

## See Also

- **[Encrypted Credential Handler](http://ucp.dev/2026-04-08/specification/examples/encrypted-credential-handler/index.md)** — Alternative pattern using encryption instead of tokenize/detokenize round-trips
- **[AP2 Mandates Extension](http://ucp.dev/2026-04-08/specification/ap2-mandates/index.md)** — Add cryptographic proof of checkout agreement for PSP verification
