...
This document specifies the Agent2Agent Protocol (A2A) binding for [Checkout Capability](http://ucp.dev/2026-04-08/specification/checkout/index.md).
...
The URI for UCP A2A extension: `https://ucp.dev/2026-04-08/specification/reference`
