...
The handler schema defines three config variants for different contexts. See [Payment Handler Guide: Defining the Schema](http://ucp.dev/2026-04-08/specification/payment-handler-guide/#defining-the-schema) for the full pattern.
