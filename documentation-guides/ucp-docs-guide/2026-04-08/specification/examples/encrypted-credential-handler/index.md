...
The only supported instrument schema is [CardPaymentInstrument](/2026-04-08/schemas/shopping/types/card_payment_instrument.json), the only supported checkout credential schema is `EncryptedCredential`, and the only supported source credential schema is [CardCredential](/2026-04-08/schemas/shopping/types/card_credential.json).
...
- **Instrument Schema:** [schemas/shopping/types/card_payment_instrument.json](/2026-04-08/schemas/shopping/types/card_payment_instrument.json)
